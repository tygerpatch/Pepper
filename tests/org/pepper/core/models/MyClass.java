...
public class MyClass extends StepDefinition {
  ...
  @Then("I should say $greeting")
  public void thenIShouldSay(String str) {
    assertThat("Hello " + firstName, equalTo(str));
  }
}
